...
/* הודלק אחרי אימות באתר החי: אפס עוגיות למבקר חדש, אפס בקשות לגוגל,
   וה-beacon של Cloudflare פועל — כלומר הנוסח תואם למה שרץ בפועל.
   אם יתווסף אי-פעם משהו שמזהה מבקרים, לכבות עד שהנוסח יעודכן. */
const SHOW_PRIVACY = true;
